...
export const techDomains: TechDomain[] = [
  {
    ...
    languages: [
      ...
      { name: 'Python', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg', description: 'Versatile general-purpose language', codeSnippet: 'def add(a,b):\n  return a+b' },
      { name: 'PHP', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg', description: 'Server-side scripting language', codeSnippet: '<?php echo "Hello"; ?>' },
      { name: 'Java', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg', description: 'Enterprise JVM language', codeSnippet: 'class Main{ public static void main(String[]a){ System.out.println("OK"); }}' },
      { name: 'C#', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg', description: 'Modern language on .NET', codeSnippet: 'var app=WebApplication.Create(); app.Run();' },
      { name: 'Ruby', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ruby/ruby-original.svg', description: 'Friendly language powering Rails', codeSnippet: 'puts "Hello"' },
      { name: 'Go', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg', description: 'Compiled language for services', codeSnippet: 'package main\nfunc main(){}' },
      { name: 'Rust', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rust/rust-original.svg', description: 'Performance and safety', codeSnippet: 'fn main(){ println!("OK"); }' }
    ],
    frameworks: [
      ...
      { name: 'Bootstrap', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg', description: 'CSS component framework', codeSnippet: '<button class="btn btn-primary">Click</button>' },
      { name: 'Tailwind CSS', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg', description: 'Utility-first CSS framework', codeSnippet: '<button class="bg-indigo-600 text-white px-4 py-2 rounded">Click</button>' },
      ...
      { name: 'NestJS', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nestjs/nestjs-plain.svg', description: 'Structured Node.js framework', codeSnippet: '@Controller()\nexport class AppController{ @Get() get(){ return "OK" } }' },
      { name: 'Django', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain.svg', description: 'Batteries-included Python framework', codeSnippet: 'from django.http import JsonResponse\ndef home(_): return JsonResponse({"ok":True})' },
      { name: 'Flask', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flask/flask-original.svg', description: 'Lightweight Python microframework', codeSnippet: '@app.get("/")\ndef home(): return "OK"' },
      { name: 'FastAPI', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/fastapi/fastapi-original.svg', description: 'Modern Python API framework', codeSnippet: 'from fastapi import FastAPI\napp=FastAPI()\n@app.get("/")\ndef home(): return {"ok":True}' },
      { name: 'Spring Boot', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg', description: 'Java framework for services', codeSnippet: '@RestController class C{ @GetMapping("/") String ok(){return "OK";} }' },
      { name: 'ASP.NET Core', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg', description: '.NET web framework', codeSnippet: 'var app=WebApplication.Create(); app.MapGet("/",()=>"OK"); app.Run();' },
      { name: 'Laravel', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-plain.svg', description: 'Elegant PHP framework', codeSnippet: 'Route::get("/", function(){ return "OK"; });' },
      { name: 'Ruby on Rails', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rails/rails-plain.svg', description: 'Convention-over-configuration framework', codeSnippet: 'Rails.application.routes.draw do root "home#index" end' },
      { name: 'Gin', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg', description: 'Fast Go web framework', codeSnippet: 'r:=gin.Default(); r.GET("/", func(c){ c.String(200,"OK") })' },
      { name: 'Actix', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rust/rust-original.svg', description: 'Actor-based Rust web framework', codeSnippet: 'HttpServer::new(|| App::new().route("/", web::get().to(|| async {"OK"})))' }
    ],
    roadmapSteps: [
      {
