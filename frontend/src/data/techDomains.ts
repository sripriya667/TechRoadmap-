...
export const techDomains: TechDomain[] = [
  {
    ...
    frameworks: [
      ...
      { name: 'Next.js', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg', description: 'React framework for SSR/SSG routing and APIs', codeSnippet: 'export default function Home(){\n  return <h1>Hello Next.js</h1>;\n}' },
