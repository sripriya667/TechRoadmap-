...
const NAME_TO_CATEGORY: Record<string, TechRoute> = {
  ...
  'next': { category: 'frontend', languageSlug: 'nextjs' },
  'nextjs': { category: 'frontend', languageSlug: 'nextjs' },
  'next.js': { category: 'frontend', languageSlug: 'nextjs' },
  ...
  'tailwind': { category: 'frontend', languageSlug: 'tailwind-css' },
  'tailwindcss': { category: 'frontend', languageSlug: 'tailwind-css' },
  ...
  // 'NestJS' omitted per request; prefer Node.js/Express
  ...
  'springboot': { category: 'backend', languageSlug: 'spring-boot' },
  ...
  'asp.net-core': { category: 'backend', languageSlug: 'asp-net-core' },
  'aspnetcore': { category: 'backend', languageSlug: 'asp-net-core' },
  'asp-net-core': { category: 'backend', languageSlug: 'asp-net-core' },
